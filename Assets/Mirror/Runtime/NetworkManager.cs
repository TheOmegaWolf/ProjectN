...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        public virtual void OnValidate()
        {
            ...
            {
                Debug.Log("NetworkManager - playerPrefab must have a NetworkIdentity.");
                playerPrefab = null;
            }
        }
        ...
        public virtual void OnServerAddPlayer(NetworkConnection conn)
        {
            ...
            GameObject player = startPos1 != null
                ? Instantiate(playerPrefab, startPos1.position, startPos1.rotation)
